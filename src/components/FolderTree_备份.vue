    ...
    <template #default="scope">
      <div style="width: 100%; display: flex; justify-content: space-between">
        ...
        <div style="margin-right: 20px">
          <el-popover ref="popover" placement="right" trigger="contextmenu">
            <template #reference>
              <el-icon>
                <Tools />
              </el-icon>
    ...
    children: [
      {
        label: "Level_two_1-1",
        type: "folder",
        path: "/Level_one_1/Level_two_1-1",
        children: [
          {
            type: "file",
            path: "/Level_one_1/Level_three_1-1-1/Level_three_1-1-1",
            label: "Level_three_1-1-1",
          },
        ],
      },
    ],
