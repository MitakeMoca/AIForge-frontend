  ...
  <el-container class="main" style="height: 80vh; min-height: 100%; padding-top: 60px">
    ...
    <el-aside width="250px" style="background-color: #f5f7fa; padding: 20px">
      ...
      <el-row :gutter="10" v-if="false">
        <el-col :span="12" v-for="tag in tags" :key="tag" style="margin-bottom: 10px">
          <el-button
    ...
    <el-container>
      ...
      >
        <div style="display: flex; align-items: center">
          ...
          <div style="text-align: center">
            <el-button @click="clearSelectedTags" style="width: 100px; margin: 30px" type="danger"> 清空选中标签 </el-button>
          </div>
          <el-select
            v-model="selected"
            placeholder="选择排序方式"
        ...
        <el-button type="primary" @click="handleShareMyModel">分享我的模型</el-button>
      </el-header>
      ...
      <el-main style="padding: 20px">
        <div class="model-square">
          ...
          <div v-else>
            <div class="grid">
              <div v-for="model in filteredModels" :key="model.modelId" class="grid-item">
