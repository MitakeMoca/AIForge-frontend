    ...
    <el-container class="manage-main">
      ...
      <el-main>
        <div class="back" @click="back">
          <el-button type="primary" :icon="Back">返回</el-button>
        </div>
        <el-scrollbar>
          <div v-if="state.currentIndex == '1'" class="user">
            <el-table :data="state.users" stripe style="width: 100%">
              <el-table-column prop="userId" label="用户ID" width="350px" />
              ...
              <el-form ref="modelForm" label-width="70px" class="model-form">
                ...
                <el-form-item label="模型文件">
                  ...
                  >
                    ...
                    <div class="el-upload__text"><em>上传</em></div>
                  </el-upload>
                </el-form-item>
          ...
          <div v-else-if="state.currentIndex == '3'" class="project">
            <el-table :data="state.projects" stripe style="width: 100%">
              ...
              <el-table-column prop="status" label="项目状态" width="120px" />
              <el-table-column
                prop="createTime"
                label="创建时间"
                width="120px"
              ...
              <el-table-column
                ...
                width="120px"
              />
              <el-table-column prop="modelId" label="模型ID" width="120px" />
              <el-table-column
                prop="storePath"
                label="存储路径"
                width="120px"
          ...
          <div v-else-if="state.currentIndex == '4'" class="dataset">
            <el-table :data="state.datasets" stripe style="width: 100%">
              <el-table-column prop="dataSetId" label="数据集ID" />
              <el-table-column prop="projectId" label="项目ID" />
              <el-table-column prop="dataSetName" label="数据集名称" />
              <el-table-column prop="dataUrl" label="存储地址" />
              <el-table-column prop="dataType" label="数据类型" />
              <el-table-column prop="dataSize" label="数据及大小" />
              ...
              <el-table-column fixed="right" label="删除">
                <template #default="scope" label="关闭">
                  <el-button
                    type="danger"
                    :icon="Close"
                    @click="deletedataset(scope.row.dataSetId)"
                  />
                </template>
              </el-table-column>
            </el-table>
  ...
  .manage-main {
    ...
    .el-main {
      ...
      .model {
        ...
        .model-input-row {
          margin-bottom: 10px; /* 为每一行之间添加一些间隔 */
          border-bottom: 1px solid #ebeef5; /* 添加分割线 */
          width: 100%;

          .model-form {
            margin-bottom: 15px; /* 增加模型之间的间隔 */
            width: 100%;
